...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-paper bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px]">
      {/* Header */}
      <header className="py-6 px-4 border-b border-gray-200 bg-white/80 backdrop-blur-sm sticky top-0 z-40">
        <div className="max-w-5xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-4">
             {/* Hidden file input for Gemini Scanner */}
             <input 
              type="file" 
              ref={fileInputRef} 
              className="hidden" 
        ...
        {currentView === 'users' && (
          <div className="max-w-4xl mx-auto animate-fade-in">
             <div className="text-center mb-12">
                ...
                <p className="text-gray-500 font-sans text-lg">Select your name to begin your dining experience.</p>
             </div>
               ...
               {FAMILY_MEMBERS.map((member) => {
                 ...
                 return (
                   <button
                    ...
                    className={`
                      relative group h-48 rounded-2xl border transition-all duration-300 flex flex-col items-center justify-center p-4
                      ${hasOrdered 
